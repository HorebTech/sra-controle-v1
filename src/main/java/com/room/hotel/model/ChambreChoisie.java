...
public class ChambreChoisie {
    ...
    @OneToMany(mappedBy = "chambreChoisie", fetch = FetchType.EAGER, cascade = CascadeType.REMOVE )
    private List<Panne> panne;

    @OneToMany(mappedBy = "chambreChoisie", fetch = FetchType.EAGER, cascade = CascadeType.REMOVE )
    private List<Objet> objet;

    @OneToMany(mappedBy = "chambreChoisie", fetch = FetchType.LAZY, cascade = CascadeType.REMOVE )
